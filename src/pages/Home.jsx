    ...
    return (
        <div className="min-h-screen bg-[#FDFBF2] font-['Outfit'] selection:bg-[#2B6B6D] selection:text-white">
            ...
            <main>
                ...
                <section className="pt-12 pb-32 px-6 md:px-12 lg:px-24 bg-white overflow-hidden transform-gpu relative">
                    ...
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-start relative z-10">
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <h2 className="serif-title text-[#2D6A6A] text-4xl md:text-6xl lg:text-7xl font-bold leading-none mb-8">
                                    Our Story
                                </h2>
                                <div className="max-w-xl mx-auto">
                                    <TextGenerateEffect
                                        ...
                                        className="text-xl text-black font-medium leading-relaxed"
                                        filter={false}
                            ...
                            >
                                <Link
                                    to="/about"
                                    className="inline-flex items-center gap-3 bg-[#E11D48] text-white px-10 py-4 rounded-full font-black uppercase tracking-[0.2em] text-xs hover:bg-[#1A1A1A] transition-all duration-300 shadow-xl group"
                                >
                                    Learn More
                            ...
                            <div className="flex-1">
                                ...
                                <div className="max-w-xl mx-auto">
                                    <TextGenerateEffect
                                        ...
                                        className="text-xl text-black/80 font-medium leading-relaxed mb-12"
                                        filter={false}
                ...
                <section className="py-32 px-6 md:px-12 lg:px-24 bg-[#2D6A6A] transform-gpu relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto text-center relative z-10">
                        ...
                        <ScrollReveal
                            ...
                            containerClassName="mb-20 max-w-4xl mx-auto"
                        >
                ...
                {/* 5. Connect Section */}
                <section className="py-32 px-6 md:px-12 lg:px-24 bg-white border-y border-[#2D6A6A]/5 transform-gpu relative">
                    <BackgroundGrid color="#2D6A6A" opacity={0.05} />
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
                        ...
                        >
                            <h2 className="serif-title text-[#2D6A6A] text-4xl md:text-6xl font-bold mb-8">Connect With Us</h2>
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
                            className="aspect-video bg-[#2D6A6A] rounded-[3rem] overflow-hidden relative shadow-2xl group transform-gpu will-change-transform"
                        >
                ...
                {/* 6. CTA Section */}
                <section id="main-footer" className="pt-40 pb-8 px-6 md:px-12 lg:px-24 bg-[#1A1A1A] text-white transform-gpu relative overflow-hidden">
                    <BackgroundGrid color="#FFFFFF" opacity={0.1} />
                    <div className="max-w-7xl mx-auto text-center space-y-12 relative z-10">
                        <motion.h2
                            ...
                            className="serif-title text-4xl md:text-6xl lg:text-7xl font-black leading-[0.9] transform-gpu will-change-transform text-white"
                        >
                            Ready to Transform <br />
                            Your Space?
                        </motion.h2>
                        <p className="text-2xl font-medium max-w-2xl mx-auto text-white">
                        ...
                        <div className="grid md:grid-cols-3 gap-12 text-center mt-20 border-t border-white/10 pt-16">
                            {/* Address */}
                        ...
                        <div className="pt-12 border-t border-white/10 flex flex-col justify-center items-center gap-6 text-xs text-white font-bold tracking-widest uppercase">
